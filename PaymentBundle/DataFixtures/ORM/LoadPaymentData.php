...
use FontCatalogueBundle\Entity\Typography;
...
class LoadPaymentData extends SqlScriptFixture
{
    public function createFixtures()
    {
            ...
            //Create Products
            $product = new Typography();
            $product->setName('Product test 1');
            $product->setInitPrice(1.84);
            $product->setPrice(0.84);
            $product->setPriceType(Typography::PRICE_TYPE_FIXED());
            $product->setDiscount(1);
            $product->setDiscountType(Typography::PRICE_TYPE_FIXED());
            $product->setStock(7);
            ...
            $product2 = new Typography();
            $product2->setName('Product test 2');
            $product2->setPrice(1.14);
            $product2->setPriceType(Typography::PRICE_TYPE_FIXED());
            $product2->setDiscount(0);
            $product2->setDiscountType(Typography::PRICE_TYPE_FIXED());
            ...
            $product3 = new Typography();
            $product3->setName('Product test 3');
            $product3->setInitPrice(10.14);
            $product3->setPrice(7.98);
            $product3->setPriceType(Typography::PRICE_TYPE_FIXED());
            $product3->setDiscount(10);
            $product3->setDiscountType(Typography::PRICE_TYPE_PERCENT());
